package feathers.themes
{
	...
	public class PowerChalkTheme extends DisplayListWatcher
	{
//		[Embed(source="/../assets/images/metalworks.png")]
		[Embed(source="/../assets/graphics/powerchalk.png")]
		protected static const ATLAS_IMAGE:Class;

		[Embed(source="/../assets/graphics/powerchalk.xml",mimeType="application/octet-stream")]
		protected static const ATLAS_XML:Class;

		protected static const LIGHT_TEXT_COLOR:uint = 0xFFFFFF;
		protected static const DARK_TEXT_COLOR:uint = 0x1a1a1a;
		protected static const SELECTED_TEXT_COLOR:uint = 0x66ff00;
		...
		public function PowerChalkTheme(root:DisplayObjectContainer, scaleToDPI:Boolean = true)
		{
			super(root)
		...
		{
			const defaultSkin:Quad = new Quad(44 * this.scale, 44 * this.scale, 0xFFFFFF);
		...
		{
			const defaultSkin:Quad = new Quad(66 * this.scale, 66 * this.scale, 0xffffff);
			defaultSkin.alpha = 0;
			renderer.backgroundSkin = defaultSkin;
